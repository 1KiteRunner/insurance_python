...
BATCH_PINGAN_QUEUE = se.BATCH_PINGAN_QUEUE
log = Logger()
...
class Consumer(object):
    ...
    def runrealtime(self):
        try:
            ...
            client.subscribe(BATCH_PINGAN_QUEUE, headers,
    ...
    def consume(self, client, frame):
        try:
            ...
            for data in body:
                data['client'] = client
                threads.deferToThread(pingan_request, session, data)
...
def main():
    try:
        reactor.suggestThreadPoolSize(2)  # 设置线程池的最大数量
