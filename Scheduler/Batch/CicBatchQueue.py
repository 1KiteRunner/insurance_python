...
from request_cic.request_getdata import getData
...
BATCH_CIC_QUEUE = se.BATCH_CIC_QUEUE
log = Logger()
...
class Consumer(object):
    ...
    def runrealtime(self):
        try:
            ...
            client.subscribe(BATCH_CIC_QUEUE, headers,
    ...
    def consume(self, client, frame):
        try:
            ...
            for data in body:
                data['client'] = client
                threads.deferToThread(getData, session, data)
